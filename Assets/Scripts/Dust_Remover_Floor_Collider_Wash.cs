// dnSpy decompiler from Assembly-CSharp.dll class: Dust_Remover_Floor_Collider_Wash
using System;
using System.Collections;
using UnityEngine;

public class Dust_Remover_Floor_Collider_Wash : MonoBehaviour
{
	private void Start()
	{
	}
	...
	private IEnumerator OnTriggerEnter(Collider col)
	{
		...
		if (base.gameObject.name == "dust_remover_carpet_coll" && col.gameObject.tag == "carpet_mud")
		{
			...
			if (this.count == 24)
			{
				...
				WashRoom_Main._inst.hand_mud_carpet.SetActive(false);
				...
				WashRoom_Main._inst.hand_spider_g.SetActive(true);
				Grid_button_Wash._inst.grid_btn[3].enabled = true;
			}
		}
		yield break;
	}
