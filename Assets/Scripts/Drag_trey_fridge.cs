// dnSpy decompiler from Assembly-CSharp.dll class: Drag_trey_fridge
using System;
using System.Diagnostics;
using UnityEngine;

[RequireComponent(typeof(BoxCollider))]
public class Drag_trey_fridge : MonoBehaviour
{
	...
	private void OnMouseUp()
	{
		...
		base.gameObject.GetComponent<SpriteRenderer>().sortingOrder = 25;
