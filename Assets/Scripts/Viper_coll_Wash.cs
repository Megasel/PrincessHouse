// dnSpy decompiler from Assembly-CSharp.dll class: Viper_coll_Wash
using System;
using System.Collections;
using UnityEngine;

public class Viper_coll_Wash : MonoBehaviour
{
	private void Start()
	{
	}
	...
	private IEnumerator OnTriggerEnter(Collider col)
	{
		...
		if (base.gameObject.name == "water_viper_coll" && col.gameObject.tag == "water_pink")
		{
			...
			if (this.count == 11)
			{
				...
				WashRoom_Main._inst.hand_pink_water.SetActive(false);
				WashRoom_Main._inst.hand_blue_water.SetActive(true);
				...
				WashRoom_Main._inst.water_blue_sm.SetActive(true);
		...
		if (base.gameObject.name == "water_viper_coll" && col.gameObject.tag == "water_blue")
		{
			...
			if (this.count == 13)
			{
				...
				WashRoom_Main._inst.hand_blue_water.SetActive(false);
				UnityEngine.Object.Destroy(this.drag_tool.GetComponent<Drag_Tool_Wash_Room>());
				iTween.MoveTo(this.drag_tool, iTween.Hash(new object[]
				{
					"x",
