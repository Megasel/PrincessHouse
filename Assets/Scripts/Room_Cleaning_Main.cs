// dnSpy decompiler from Assembly-CSharp.dll class: Room_Cleaning_Main
using System;
using UnityEngine;

public class Room_Cleaning_Main : MonoBehaviour
{
	private void Start()
	{
		SoundManager.Instance.Click_s();
		if (Room_Cleaning_Main._inst == null)
		{
			Room_Cleaning_Main._inst = this;
		}
	...
	public static Room_Cleaning_Main _inst;
