// dnSpy decompiler from Assembly-CSharp.dll class: spider_boom_coll
using System;
using System.Collections;
using UnityEngine;

public class spider_boom_coll : MonoBehaviour
{
	private void Start()
	{
	}
	...
	private IEnumerator OnTriggerEnter(Collider col)
	{
		...
		if (base.gameObject.name == "spider_boom_coll" && col.gameObject.tag == "spider")
		{
			...
			if (this.count == 11)
			{
				...
				this.count = 0;
				Room_Cleaning_Main._inst.hand_spider.SetActive(false);
				...
				Room_Cleaning_Main._inst.hand_water_g.SetActive(true);
				Grid_button._inst.grid_btn[4].enabled = true;
			}
		}
		yield break;
	}
