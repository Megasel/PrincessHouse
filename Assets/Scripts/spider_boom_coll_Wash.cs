// dnSpy decompiler from Assembly-CSharp.dll class: spider_boom_coll_Wash
using System;
using System.Collections;
using UnityEngine;

public class spider_boom_coll_Wash : MonoBehaviour
{
	private void Start()
	{
	}
	...
	private IEnumerator OnTriggerEnter(Collider col)
	{
		...
		if (base.gameObject.name == "spider_boom_coll" && col.gameObject.tag == "spider")
		{
			...
			if (this.count == 11)
			{
				...
				WashRoom_Main._inst.hand_spider.SetActive(false);
				...
				WashRoom_Main._inst.hand_water_g.SetActive(true);
				Grid_button_Wash._inst.grid_btn[4].enabled = true;
			}
		}
		yield break;
	}
