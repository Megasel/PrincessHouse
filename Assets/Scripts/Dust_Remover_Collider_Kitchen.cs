// dnSpy decompiler from Assembly-CSharp.dll class: Dust_Remover_Collider_Kitchen
using System;
using System.Collections;
using UnityEngine;

public class Dust_Remover_Collider_Kitchen : MonoBehaviour
{
	private void Start()
	{
	}
	...
	private IEnumerator OnTriggerEnter(Collider col)
	{
		...
		if (base.gameObject.name == "dust_remover_coll" && col.gameObject.tag == "mud_mask_green")
		{
			...
			if (this.count == 12)
			{
				...
				this.count = 0;
				Kitchen_Main._inst.hand_green_table.SetActive(false);
				Kitchen_Main._inst.hand_purple_table.SetActive(true);
				...
				Kitchen_Main._inst.purple_mud_sm.SetActive(true);
		...
		if (base.gameObject.name == "dust_remover_coll" && col.gameObject.tag == "mud_mask_purple")
		{
			...
			if (this.count == 21)
			{
				...
				Kitchen_Main._inst.hand_purple_table.SetActive(false);
				Kitchen_Main._inst.hand_pink_table.SetActive(true);
				iTween.MoveTo(this.drag_tool, iTween.Hash(new object[]
				{
					"x",
					3.95f,
				...
				yield return new WaitForSeconds(1f);
				Kitchen_Main._inst.pink_mud_sm.SetActive(true);
		...
		if (base.gameObject.name == "dust_remover_coll" && col.gameObject.tag == "mud_mask_pink")
		{
			...
			if (this.count == 6)
			{
				...
				Kitchen_Main._inst.hand_pink_table.SetActive(false);
				iTween.MoveTo(this.drag_tool, iTween.Hash(new object[]
				{
					"x",
					10.568161f,
				...
				yield return new WaitForSeconds(1f);
				Kitchen_Main._inst.hand_mud_carpet_g.SetActive(true);
				Grid_button_Kitchen._inst.grid_btn[2].enabled = true;
				Kitchen_Main._inst.Ads.SetActive(true);
				yield return new WaitForSeconds(0.1f);
				Kitchen_Main._inst.Ads.SetActive(false);
			}
		}
		yield break;
	}
